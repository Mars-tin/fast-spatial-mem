...
class NVSVideoDatasetInference(Dataset):
    """
    ...
    def __init__(
        ...
        self.num_target_views = num_views - num_input_views
    ...
    def __getitem__(self, index):
        ...
        if self.is_inference and isinstance(scene_obj, dict) and ("index_plan" in scene_obj):
            ...
            step = window_size / self.num_views
            chosen_indices = [candidate_indices[int(i * step)] for i in range(self.num_views)]
            input_index = chosen_indices[0::2][:self.num_input_views]
            target_index = chosen_indices[1::2][:self.num_target_views]
            chosen_indices = input_index + target_index
