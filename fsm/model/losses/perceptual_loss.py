...
# the Crowdsampling The Plenoptic Function Authors under the MIT License.
#
...
class PerceptualLoss(nn.Module):
    """
    Perceptual loss module using VGG19 features.
    ...
    def __init__(self, device="cpu"):
        ...
        assert os.path.isfile(
            weight_file
        ), f"Follow README and prepare VGG19 from https://www.vlfeat.org/matconvnet/pretrained/"
