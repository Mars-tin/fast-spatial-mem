...
python -m torch.distributed.run \
  ...
  launch_training.py \
  --config fsm/configs/train/fsm_lrm_upscale.yaml \
  --load_ckpt static/weights/fsm_4dlrm_patch8_res128.pth \
  --wandb_name fsm_upscale_lrm \
  --expname fsm_upscale_lrm_patch8_res256
